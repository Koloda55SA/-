  ...
  Future<void> _generateWaybill() async {
    ...
    try {
      ...
      final waybillData = <String, dynamic>{
        ...
        'garageNumber': s(driver, 'plateNumber'),
        'tabNumber': s(driver, 'plateNumber'),
        ...
        'medName': 'Самышина Елена Александровна',
        'medSerial': 'b8d46c0e277c1e06a40c8e3e253d9e6c',
        'medCert': '',
        'medIssued': '2025-11-15',
        'medExpires': '2026-11-15',
        'techName': 'Темишов Бекмырза',
        'techSerial': '519756c9191b011ca7d2e9508fc7877d',
        'techCert': '',
        'techIssued': '2025-11-20',
        'techExpires': '2026-11-20',
